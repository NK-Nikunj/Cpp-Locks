...
void no_locks(std::uint64_t num_tasks, std::uint64_t grain_size)
{
    ...
    hpx::for_loop(hpx::execution::par, 0ul, num_tasks, 
        [&cases, grain_size](std::uint64_t) {
            cases.base_case(grain_size);
        });
}
////////////////////////////////////////////////////////////////////////////////
